...
# script in gain978.php will read gain value stored in currentgain and
...
do
        ...
        # script in gain978.php will read the updated gain and display it on map
